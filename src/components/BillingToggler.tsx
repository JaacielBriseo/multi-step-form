...
import { setPaymentType, useAppDispatch } from '../store';
interface TogglerProps {
	enabled: boolean;
	setEnabled: React.Dispatch<React.SetStateAction<boolean>>;
	setIsSelected: React.Dispatch<SetStateAction<number | null>>;
}

export const BillingToggler = ({ enabled, setEnabled, setIsSelected }: TogglerProps) => {
